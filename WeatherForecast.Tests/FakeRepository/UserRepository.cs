...
namespace WeatherForecast.Tests.FakeRepository
{
    public class UserRepository : Repository<User>, IUserRepository
    {
        public UserRepository(FakeContext context) : base(context)
        {
        }
        ...
        public FakeContext Db
        {
            get { return Context as FakeContext; }
        }
    }
}